...
function makeTransport(overrides: Partial<AxonMindTransport> = {}): AxonMindTransport {
  ...
  return {
    ...
    listDocuments: stub, listIngestStatus: stub, listTrash: stub, listDocumentVersions: stub, getDocumentContent: stub,
    removeDocument: stub, regenerateDocument: stub, trashDocument: stub, restoreDocument: stub,
    deleteDocumentPermanently: stub, emptyTrash: stub,
    startIngest: stub, cancelIngest: stub, cancelIngestFile: stub,
