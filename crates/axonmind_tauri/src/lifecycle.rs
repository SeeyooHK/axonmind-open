...
fn init_inner<R: Runtime>(
    ...
    tauri::plugin::Builder::<R>::new("axonmind")
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::commands::start_ingest,
            crate::commands::cancel_ingest,
            crate::commands::cancel_ingest_file,
            crate::commands::index_markdown,
            crate::commands::parse_and_index,
            crate::commands::list_documents,
            crate::commands::list_ingest_status,
            crate::commands::list_trash,
            ...
            crate::commands::trash_document,
            crate::commands::restore_document,
            crate::commands::delete_document_permanently,
            crate::commands::empty_trash,
